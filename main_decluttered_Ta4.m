...
for step=93500:500:200000
    BaseName='zzFinedump.Ta4_550_N12_StressVolumePress1L_';
    ...
    slip_atomid   = 1506824;% %ID of the atom to get the location of that atom's information in the slip vector
...
% %      C = C';    
    ...
    G1_Ta4 = [13 -4 5; 34 63 -38; -163 664 955];

    G1_Ta4  = [G1_Ta4(1,1)/norm(G1_Ta4(1,:)) G1_Ta4(1,2)/norm(G1_Ta4(1,:)) G1_Ta4(1,3)/norm(G1_Ta4(1,:));   
               G1_Ta4(2,1)/norm(G1_Ta4(2,:)) G1_Ta4(2,2)/norm(G1_Ta4(2,:)) G1_Ta4(2,3)/norm(G1_Ta4(2,:));
               G1_Ta4(3,1)/norm(G1_Ta4(3,:)) G1_Ta4(3,2)/norm(G1_Ta4(3,:)) G1_Ta4(3,3)/norm(G1_Ta4(3,:))];
    
    %Find A which is the rotation matrix from
    %the lab frame into the crystal frame
    for i=1:3
       for j=1:3
           A(i,j) = dot(G1_Ta4(i,:),L(j,:));
       end
    end
        A = A';
...
k = 1; %Counter for the number of files read in
for step=95000:500:200000
    BaseName2='zzFinedump.Ta4_550_N12_StressVolumePress2R_';
    ...
    %Normalize the crystal frame matrix
    G2_Ta4 = [32 20 -8; -20 36 10 ;488 -160 1552];
    G2_Ta4  = [G2_Ta4(1,1)/norm(G2_Ta4(1,:)) G2_Ta4(1,2)/norm(G2_Ta4(1,:)) G2_Ta4(1,3)/norm(G2_Ta4(1,:));   
               G2_Ta4(2,1)/norm(G2_Ta4(2,:)) G2_Ta4(2,2)/norm(G2_Ta4(2,:)) G2_Ta4(2,3)/norm(G2_Ta4(2,:));
               G2_Ta4(3,1)/norm(G2_Ta4(3,:)) G2_Ta4(3,2)/norm(G2_Ta4(3,:)) G2_Ta4(3,3)/norm(G2_Ta4(3,:))];
